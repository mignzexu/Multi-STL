...
class Main(nn.Module):
    ...
    def build_model(self):
        ...
        return SwinLSTM_D_Model(depths_downsample, depths_upsample, num_heads, self.configs)
    ...
    def forward(self, batch_x, batch_y=None):
        ...
        img_gen = self.model(test_ims, return_loss=False)
        pred_y = img_gen['pred'][:, -self.aft_seq_length:].permute(0, 1, 4, 2, 3).contiguous()
